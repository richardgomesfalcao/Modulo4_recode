...
<title>Stilus Viagens - Atualizar Cliente</title>
<link
		...
		<div class="row">
			<div class="cold-md-7">
				...
				<form action="ClienteUpdate" method="POST">
					...
					<div class="form-floating mb-3">
						<input value="${cliente.sobrenome}" name="cpf" maxlength="11"
							type="text" class="form-control"> <label>Sobrenome</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${cliente.email}" name="nascimento" type="date"
							class="form-control" placeholder="Nascimento"> <label>Email</label>
					</div>
